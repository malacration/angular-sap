...
export class ParceiroNegocio{
    ...
    constructor(cpfCnpj : String, numeroDocumentoFiscal : String, cnpjFilial : String, valor : number, dataVecimento : Date){
        this.cpfCnpj = cpfCnpj
        this.addDocumento(numeroDocumentoFiscal,cnpjFilial,valor, dataVecimento)
    }

    addDocumento(numero : String, cnpjFilial : String,valor : number, dataVecimento : Date){
